...
class RouteDecision(BaseModel):
    step: str = Field(
        description="Choose 'memory_agent' to save/remember data. Choose 'filesystem_agent' to read files or list directories. Choose 'general_chat' for normal questions."
    )
